...
public class SnowPanel {
     ...
     */
    public SnowPanel(SnowParameters snowParameters) {
    ...
    private void startAnimation() {
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                int flakesToCreate = (int) (flakeDelta * snowParameters.getFlakesPerSecondDensity() * canvas.getWidth());
                if (flakesToCreate != 0) {
    ...
    public void createFlakes(int flakesToCreate) {
        for (int i = 0; i < flakesToCreate; i++) {
            double value = (random.nextDouble() * snowParameters.getMaxFlakeSpeed()) + 1;
            for (int j = 0; j < 2; j++) {
                double newValue = (random.nextDouble() * snowParameters.getMaxFlakeSpeed()) + 1;
